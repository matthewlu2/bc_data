...
setwd(dir); print(dir)  # "/Users/lees18/Library/CloudStorage/OneDrive-UPMC/S80d_BRCAERpos_scRNAseq_Website/11j_OutgridLinedotplot_Correl_PathwayActivity_GeneExp_ColorTAMFract_TAM"
...
CellTypeNumb<-0; 
for(EachCellTypeSubset in MyCellTypeSubset) {
      # EachCellTypeSubset <- MyCellTypeSubset[10]  # 5 is  "CancerEpithelial"
      CellTypeNumb <- CellTypeNumb+1
      print(paste0("currnt cell type: ", EachCellTypeSubset))
      ...
      GeneExpCount=0;
      for(EachCytoGene in MyCytokine[9334:length(MyCytokine)]) {
