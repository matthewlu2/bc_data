...
#         # EachCellTypeSubset <- MyCellTypeSubset[1]
...
CellTypeNumb<-0; 
for(EachCellTypeSubset in MyCellTypeSubset) {
      # EachCellTypeSubset <- MyCellTypeSubset[5]  # 5 is  "CancerEpithelial"
      CellTypeNumb <- CellTypeNumb+1
      print(paste0("currnt cell type: ", EachCellTypeSubset))
      ...
      GeneExpCount=0;
      for(EachCytoGene in MyCytokine[16515:length(MyCytokine)]) {
